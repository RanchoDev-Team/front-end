      ...
      <Content>
        <ThreeColRow>
          <LogoContainer>
            ...
            <LogoText>RANCHODEV</LogoText>
          </LogoContainer>
          <CopywrightNotice>&copy; 2021 RanchoDev. Todos os direitos reservados.</CopywrightNotice>
          <SocialLinksContainer>
            <SocialLink target="_blank" href="https://pt-br.facebook.com/RDCONF/">
              <FacebookIcon />
            </SocialLink>
            <SocialLink target="_blank" href="https://www.linkedin.com/showcase/ranchodev">
              <LinkedinIcon />
            </SocialLink>
            <SocialLink target="_blank" href="https://www.instagram.com/ranchodev/?hl=en">
              <InstagramIcon />
            </SocialLink>
          </SocialLinksContainer>
        </ThreeColRow>
